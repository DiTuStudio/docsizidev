...
Wanawi is a React Native UIKIT template application.

## Reference

- Expo Demo: https://timivietnam.github.io/wanawi/
- Android Demo: https://play.google.com/store/apps/details?id=com.timistudio.Wanawi
